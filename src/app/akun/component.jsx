...
export function BackToIndexPageButton() {
  return (
    <Link href="/" className="button h-12 self-start text-lg flex gap-2 -ml-4 px-4 shadow-none  text-white outline-white/50">
...
export function BackToAkunPageButton() {
  return (
    <Link href="/akun" className="button h-12 self-start flex gap-2 -ml-4 px-4 shadow-none text-lg  text-white outline-white/50">
...
export function LayoutPenyetelanAkun({ children, title }) {

  return (
    <>
      <BackToAkunPageButton />
      <div className="py-8">
        <div className="text-xl font-semibold text-white">Penyetelan</div>
