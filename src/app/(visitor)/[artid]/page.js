    ...
    <section className="max-w-screen-xl mx-auto  flex-1 mt-8">
      <div className="mx-4 flex flex-col lg:flex-row gap-8 items-center lg:items-start">
        ...
        <div className="flex-1  max-w-sm self-center lg:self-start w-4/5 flex flex-col gap-4">
          ...
          {/* CTO Bar */}
          <div className="bg-white p-6 rounded-t-xl lg:rounded-xl fixed bottom-0 left-0 right-0 lg:static
          ...
          ">
            ...
            <div className="flex gap-2 justify-stretch">
              <button className="lg:hidden button text-lg flex-1">Lihat Harga</button>
              <button className="button btn-primary text-lg flex-1">Kontak</button>
            </div>
          </div>
        </div>

        {/* Content */}
        <div className="bg-white flex-1 flex-grow-[2] py-4 pb-20 px-4 w-full max-w-screen-md
          [&_h2]:text-2xl
          [&_h2]:font-semibold
          [&_h2]:mt-8
          [&_hr]:my-8
        ">
          ...
          <div className="flex gap-2 my-2 items-center flex-wrap">
            ...
            <div>
              {art.location.kecamatan}
            </div>
          </div>
          <div className="flex gap-2 my-2 items-center">
            <PhPersonFill className="text-neutral-400" />
            <div>{art.mitra.dateOfBirth.getTime()}</div>
          </div>
          ...
          <div>
            {
              art.mitra.expertises.map(e =>
                <div
                  className="my-3 text-lg list-item list-inside"
                  key={e}>
                  {e}
                </div>
              )
          ...
          <div className="text-xl leading-none flex flex-col gap-4 mt-4">
            <div className="">
              <div className="text-base font-semibold leading-loose">Per Jam</div>
              <div>
            ...
            <div className="">
              <div className="text-base font-semibold leading-loose">Harian</div>
              <div>
                <span className="text-neutral-400">Rp. </span>
            ...
            <div className="">
              <div className="text-base font-semibold leading-loose">Bulanan</div>
              <div>
                <span className="text-neutral-400">Rp. </span>
...
export function PhMapPinFill(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256" {...props}><path fill="currentColor" d="M128 16a88.1 88.1 0 0 0-88 88c0 75.3 80 132.17 83.41 134.55a8 8 0 0 0 9.18 0C136 236.17 216 179.3 216 104a88.1 88.1 0 0 0-88-88m0 56a32 32 0 1 1-32 32a32 32 0 0 1 32-32"></path></svg>
  )
}
...
export function PhPersonFill(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256" {...props}><path fill="currentColor" d="M100 36a28 28 0 1 1 28 28a28 28 0 0 1-28-28m115.42 104.78l-45.25-51.3a28 28 0 0 0-21-9.48h-42.34a28 28 0 0 0-21 9.48l-45.25 51.3a16 16 0 0 0 22.56 22.69L89 142.7l-19.7 74.88a16 16 0 0 0 29.08 13.35L128 180l29.58 51a16 16 0 0 0 29.08-13.35L167 142.7l25.9 20.77a16 16 0 0 0 22.56-22.69Z"></path></svg>
  )
}